...
function capitulo24() {
  return [
    B.chapterHeading(24, "Vía judicial: competencia, procedimiento y costas"),

    B.sumario([
      "24.1. Competencia territorial: el fuero especial del domicilio del asegurado",
      "24.2. Elección de procedimiento según la cuantía",
      "24.3. Legitimación activa y pasiva",
      "24.4. La prueba en el proceso de seguro de hogar",
      "24.5. Costas procesales",
      "24.6. Ficha para el profesional",
      "24.7. Ficha para el asegurado",
      "24.8. Checklist: preparación de la demanda o de la contestación",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("24.1. Competencia territorial: el fuero especial del domicilio del asegurado"),
    ...
    B.h2("24.2. Elección de procedimiento según la cuantía"),
    ...
    B.bullet([B.bold("Interrogatorio de parte: "), B.run("particularmente relevante cuando se discuten hechos relativos al conocimiento de circunstancias declaradas o no declaradas al contratar (capítulo 4), o a la diligencia empleada por el asegurado en la custodia de los bienes (capítulo 9).")]),

    B.h2("24.5. Costas procesales"),
    ...
    B.h2("24.6. Ficha para el profesional"),
    ...
    B.h2("24.7. Ficha para el asegurado"),
    ...
    B.h2("24.8. Checklist: preparación de la demanda o de la contestación"),
    ...
    B.bullet("6. ¿Se ha acreditado el intento de negociación previa conforme al art. 264.4.º LEC (capítulo 23)?"),
