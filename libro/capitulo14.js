...
function capitulo14() {
  return [
    B.chapterHeading(14, "Peritación: designación, procedimiento y tercer perito"),

    B.sumario([
      "14.1. El procedimiento pericial del art. 38 LCS: naturaleza y función",
      "14.2. Fases del procedimiento: designación, acuerdo y tercer perito",
      "14.3. El alcance vinculante del dictamen: la distinción clave entre liquidación del daño e interpretación del contrato",
      "14.4. La impugnación judicial del dictamen: plazos y requisitos",
      "14.5. Retraso del asegurado en la iniciación del expediente y sus consecuencias sobre los intereses",
      "14.6. Ficha para el profesional",
      "14.7. Ficha para el asegurado",
      "14.8. Checklist: gestión del procedimiento pericial",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("14.1. El procedimiento pericial del art. 38 LCS: naturaleza y función"),
    ...
    B.h2("14.2. Fases del procedimiento: designación, acuerdo y tercer perito"),
    ...
    B.h2("14.3. El alcance vinculante del dictamen: liquidación del daño frente a interpretación del contrato"),
    ...
    B.h2("14.4. La impugnación judicial del dictamen: plazos y requisitos"),
    ...
    B.h2("14.5. Retraso del asegurado en la iniciación del expediente y sus consecuencias sobre los intereses"),
    B.p("Cuando el retraso en la tramitación del expediente pericial es imputable al propio asegurado —por ejemplo, por demorar la designación de su perito o la aportación de la documentación necesaria—, dicho retraso puede repercutir en el cómputo de los intereses de demora del art. 20 LCS, estudiados en el capítulo 16, en la medida en que la falta de liquidez de la indemnización durante ese período pueda considerarse, según las circunstancias del caso, causa justificada de exoneración parcial de la aseguradora, sin que ello suponga alterar el término inicial legal del cómputo (la fecha del siniestro), sino modular la eventual concurrencia de causa justificada durante el período de demora efectivamente imputable al asegurado."),
    ...
    B.h2("14.8. Checklist: gestión del procedimiento pericial"),
