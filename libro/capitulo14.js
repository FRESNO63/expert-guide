...
function capitulo14() {
  return [
    ...
    B.sumario([
      "14.1. El seguro de defensa jurídica como garantía autónoma",
      "14.2. El derecho de libre elección de abogado y procurador",
      "14.2.1. La delimitación del ámbito de cobertura por las Audiencias Provinciales",
      "14.3. Los límites cuantitativos a la libre elección: delimitadores, limitativos o lesivos",
      "14.4. Conflicto de intereses y defensa independiente en la garantía de responsabilidad civil",
      "14.5. La garantía de asistencia en el hogar",
      "14.6. Ficha para el profesional",
      "14.7. Ficha para el asegurado",
      "14.8. Checklist: activación de la cobertura de defensa jurídica",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("14.1. El seguro de defensa jurídica como garantía autónoma"),
    B.p(["La LCS dedica a esta garantía un régimen propio, distinto del general de responsabilidad civil, en los arts. 76.a) a 76.g), incorporados por la Ley 21/1990 en trasposición de la normativa comunitaria sobre seguro de defensa jurídica. Aunque en la práctica del hogar se contrata siempre integrada en la póliza multirriesgo, conserva su autonomía funcional: cubre los gastos derivados de la defensa jurídica del asegurado, no la indemnización de un daño causado a un tercero", B.fn("La autonomía del seguro de defensa jurídica frente al de responsabilidad civil, pese a su frecuente coexistencia en una misma póliza y a su origen normativo común en la transposición de la Directiva 87/344/CEE, es un rasgo estructural destacado unánimemente por la doctrina; cfr. BATALLER GRAU, J. et al., op. cit., ad arts. 76.a) a 76.g). La doctrina especializada en el ramo del automóvil —donde la litigiosidad de esta garantía es históricamente más abundante, pero cuyas conclusiones son extrapolables al hogar por regularse en idénticos preceptos— ha señalado la persistente dificultad práctica de distinguir con nitidez, ante una misma reclamación, la cobertura de defensa jurídica en sentido propio (art. 76.a) LCS) de la simple dirección jurídica accesoria a la responsabilidad civil (art. 74 LCS), así como los problemas de calificación de la cláusula de límite cuantitativo ya tratados en el epígrafe 14.3; vid. DACHS, M., «El seguro de defensa jurídica: cuestiones suscitadas en la praxis aseguradora en el ámbito del automóvil», Revista de Responsabilidad Civil y Seguro, INESE; OLMOS PILDÁIN, A., El seguro de defensa jurídica, Aranzadi, Cizur Menor, 1997, obra de referencia sobre la naturaleza de la cláusula de límite cuantitativo como delimitadora de cobertura y no como restricción encubierta del derecho de libre elección."), "."]),
    ...
    B.h2("14.2. El derecho de libre elección de abogado y procurador"),
    ...
    B.h3("14.2.1. La delimitación del ámbito de cobertura por las Audiencias Provinciales"),
    ...
    B.h2("14.3. Los límites cuantitativos a la libre elección: delimitadores, limitativos o lesivos"),
    ...
    B.h2("14.4. Conflicto de intereses y defensa independiente en la garantía de responsabilidad civil"),
    ...
    B.h2("14.5. La garantía de asistencia en el hogar"),
    ...
    B.h2("14.6. Ficha para el profesional"),
    ...
    B.h2("14.7. Ficha para el asegurado"),
    ...
    B.h2("14.8. Checklist: activación de la cobertura de defensa jurídica"),
    ...
    B.p("DACHS, M., «El seguro de defensa jurídica: cuestiones suscitadas en la praxis aseguradora en el ámbito del automóvil», Revista de Responsabilidad Civil y Seguro, INESE."),
    B.p("OLMOS PILDÁIN, A., El seguro de defensa jurídica, Aranzadi, Cizur Menor, 1997."),
  ];
}
