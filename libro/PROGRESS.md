...
- Ampliación del Anexo III con más fichas jurisprudenciales si se desea acercar el número al de 40-60 fichas del proyecto de referencia (actualmente 29 fichas de resoluciones verificadas y citadas en el cuerpo del libro).
- Ampliación del Anexo VI con más artículos/tesis doctrinales sobre las líneas señaladas como pendientes (seguro de robo/negligencia grave, reasonable expectations doctrine comparada).
