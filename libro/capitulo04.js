...
function capitulo04() {
  return [
    ...
    B.sumario([
      ...
      "3.3.1. La agravación del riesgo durante la vigencia del contrato (arts. 11 y 12 LCS)",
      "3.4. El pago de la prima y sus consecuencias (art. 15 LCS)",
      "3.5. Duración, prórroga y oposición a la renovación (art. 22 LCS)",
    ...
    B.h2("3.5. Duración, prórroga y oposición a la renovación"),
    ...
    B.h2("3.8. Checklist: el cuestionario de riesgo en el seguro de hogar"),
