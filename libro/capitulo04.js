...
function capitulo04() {
  return [
    B.chapterHeading(4, "Condiciones generales, particulares y especiales: profundización práctica"),
    ...
    B.p(["Antes de discutir qué dice una cláusula, es necesario comprobar si esa cláusula llegó siquiera a formar parte del contrato. Es lo que la doctrina denomina control de incorporación, regulado, para el tomador que actúa como adherente, por la Ley 7/1998, de Condiciones Generales de la Contratación (LCGC)", B.fn("El control de incorporación opera con independencia de que el adherente sea o no consumidor, a diferencia del control de contenido (cláusulas abusivas), reservado a los adherentes que ostenten la condición de consumidor o usuario; cfr. capítulo 21 de esta obra."), ":"]),
    ...
    B.bullet([B.bold("Cláusulas de exclusión por falta de mantenimiento o vetustez de instalaciones: "), B.run("requieren especial atención al requisito de destacado formal y aceptación específica, por su potencial de vaciar de contenido la cobertura típica de daños por agua en viviendas de cierta antigüedad (capítulo 6 y capítulo 12).")]),

    B.h2("4.5. El control de contenido cuando el tomador es consumidor: remisión"),
    B.p("Cuando el tomador del seguro de hogar tiene la condición de consumidor o usuario —el supuesto ampliamente mayoritario en la práctica—, a los controles de incorporación e interpretación se añade un tercer control, el de contenido, que permite declarar la nulidad de las cláusulas abusivas conforme al Texto Refundido de la Ley General para la Defensa de los Consumidores y Usuarios, con independencia de que superen o no los controles anteriores. Este control de contenido, con su propia metodología y casuística, se desarrolla con detalle en el capítulo 21 de esta obra."),
    ...
    B.fichaBox("Metodología de análisis de una cláusula controvertida", B.AZUL, [
      ...
      "Paso 5 — Contenido: si el tomador es consumidor, verificar adicionalmente su conformidad con el TRLGDCU (capítulo 21).",
    ]),
