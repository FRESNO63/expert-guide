...
function capitulo04() {
  return [
    B.chapterHeading(4, "Formación del contrato y deber de declaración del riesgo"),

    B.sumario([
      "4.1. Fases de formación del contrato: solicitud, proposición y perfección (arts. 5 y 6 LCS)",
      "4.2. El deber precontractual de declaración del riesgo (art. 10 LCS)",
      "4.3. Consecuencias del incumplimiento del deber de declaración",
      "4.3.1. La agravación del riesgo durante la vigencia del contrato (arts. 11 y 12 LCS)",
      "4.4. El pago de la prima y sus consecuencias (art. 15 LCS)",
      "4.5. Duración, prórroga y oposición a la renovación (art. 22 LCS)",
      "4.6. Ficha para el profesional",
      "4.7. Ficha para el asegurado",
      "4.8. Checklist: el cuestionario de riesgo en el seguro de hogar",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("4.1. Fases de formación del contrato: solicitud, proposición y perfección"),
    ...
    B.h2("4.2. El deber precontractual de declaración del riesgo"),
    ...
    B.h2("4.3. Consecuencias del incumplimiento del deber de declaración"),
    ...
    B.h3("4.3.1. La agravación del riesgo durante la vigencia del contrato"),
    ...
    B.h2("4.4. El pago de la prima y sus consecuencias"),
    ...
    B.h2("4.5. Duración, prórroga y oposición a la renovación"),
    B.p(["El seguro de hogar es, típicamente, un contrato de duración anual prorrogable, régimen que la LCS somete a un mecanismo de silencio positivo —opuesto al del art. 47 LCS estudiado en el capítulo 7— cuya inobservancia genera una de las fuentes de reclamación más frecuentes en la práctica: la renovación automática de una póliza que el tomador creía haber cancelado, o la extinción de una cobertura que el asegurado daba por prorrogada"]),
    B.legalBox("Art. 22 LCS", "1. La duración del contrato será determinada en la póliza, la cual no podrá fijar un plazo superior a diez años. Sin embargo, podrá establecerse que se prorrogue una o más veces por un período no superior a un año cada vez. 2. Las partes pueden oponerse a la prórroga del contrato mediante una notificación escrita a la otra parte, efectuada con un plazo de, al menos, un mes de anticipación a la conclusión del período del seguro en curso cuando quien se oponga a la prórroga sea el tomador, y de dos meses cuando sea el asegurador. 3. El asegurador deberá comunicar al tomador, al menos con dos meses de antelación a la conclusión del período en curso, cualquier modificación del contrato de seguro. 4. Las condiciones y plazos de la oposición a la prórroga de cada parte [...] deberán destacarse en la póliza."),
    B.p("Tres reglas prácticas se extraen de este precepto. Primera, el plazo de preaviso es asimétrico: un mes para el tomador que no desea renovar, dos meses para la aseguradora, lo que exige al profesional que asesora a un asegurado que quiere cambiar de compañía anticiparse con margen suficiente antes del vencimiento anual. Segunda, cualquier modificación del contrato con ocasión de la renovación (por ejemplo, un incremento de prima o un cambio de condiciones) debe comunicarse con dos meses de antelación, comunicación cuya ausencia o insuficiencia puede ser invocada por el tomador para rechazar la modificación y exigir la continuidad de las condiciones anteriores. Tercera, las condiciones y plazos de oposición a la prórroga deben figurar destacados en la póliza, en un requisito de transparencia adicional y específico que se suma —sin confundirse con él— al régimen general del art. 3 LCS estudiado en los capítulos 1 y 5."),
    ...
    B.fichaBox("Puntos de control ante una denegación de cobertura por el art. 10 LCS", B.AZUL, [
      ...
      "Ante una renovación o modificación discutida, verificar el cumplimiento estricto de los plazos de preaviso del art. 22 LCS y el destacado formal de las condiciones de oposición a la prórroga.",
    ]),
    ...
    B.fichaBox("Recomendaciones al contratar y durante la vigencia de la póliza", "8A5A00", [
      ...
      "Si quiere cambiar de aseguradora, comunique su oposición a la renovación por escrito con al menos un mes de antelación al vencimiento anual de su póliza.",
    ]),

    B.h2("4.8. Checklist: el cuestionario de riesgo en el seguro de hogar"),
