...
function anexoIV() {
  ...
  return [
    ...
    B.p("Se recogen a continuación seis modelos de escritos de uso frecuente en la práctica del seguro de hogar, ordenados según la secuencia habitual de una reclamación: de la vía extrajudicial (burofax de reclamación previa, escrito ante el Servicio de Atención al Cliente, escrito de designación e impugnación pericial) a la vía judicial (demandas de juicio verbal y de reclamación de intereses del art. 20 LCS) y a la vía administrativa de supervisión (queja ante la DGSFP)."),
    B.p("Los modelos se ofrecen como plantilla de trabajo y no como escrito cerrado: los datos entre corchetes deben sustituirse por los del caso concreto, y los fundamentos jurídicos deben completarse y adaptarse a las circunstancias fácticas y a la póliza efectivamente contratada. Los preceptos legales citados en cada modelo se corresponden con el texto consolidado vigente en la fecha de cierre de este anexo."),
    B.spacer(200),

    // ============ MODELO 1 ============
    ...modeloHeading(1, "Burofax de reclamación previa a la aseguradora",
      "Escrito extrajudicial dirigido a la aseguradora para reclamar el pago de la indemnización, dejar constancia fehaciente de la reclamación e interrumpir el plazo de prescripción de dos años del art. 23 LCS, conforme al art. 1973 CC. Es, además, presupuesto habitual —y en muchos casos exigencia contractual o de buena práctica procesal— antes de acudir a la vía judicial."),
    documentoBox([
    ...
    // ============ MODELO 2 ============
    ...modeloHeading(2, "Reclamación ante el Servicio de Atención al Cliente y el Defensor del Asegurado",
      "Escrito con el que se agota la vía interna de reclamación de la aseguradora (art. 30 LOSSEAR y normativa de protección del cliente financiero), requisito habitual antes de acceder a la vía de reclamación ante la DGSFP (Anexo IV, Modelo 6) y elemento de prueba de la diligencia del reclamante."),
    documentoBox([
    ...
    // ============ MODELO 3 ============
    ...modeloHeading(3, "Designación de perito de parte e impugnación del dictamen pericial (art. 38 LCS)",
      "Escrito dirigido a la aseguradora para (a) designar perito de parte al inicio del procedimiento de peritación del art. 38 LCS, o (b) impugnar judicialmente el dictamen pericial contradictorio dentro de los plazos del propio art. 38 LCS (treinta días para el asegurador, ciento ochenta para el asegurado, desde la notificación del dictamen)."),
    documentoBox([
    ...
    documentoBox([
      ...
      B.formPara("QUINTO.- Reclamación previa. Con fecha [fecha] se remitió a la demandada burofax de reclamación previa, sin que se haya obtenido respuesta satisfactoria (Documento n.º 7).", { indent: true }),
    ...
    // ============ MODELO 6 ============
    ...modeloHeading(6, "Reclamación ante la Dirección General de Seguros y Fondos de Pensiones (DGSFP)",
