...
function capitulo07() {
  return [
    ...
    B.sumario([
      "7.1. El concepto legal de incendio (art. 45 LCS)",
      "7.2. Extensión de la cobertura y daños indemnizables (art. 49 LCS)",
      "7.3. Objetos de valor y bienes excluidos de la cobertura estándar (art. 46 LCS)",
      "7.4. Causas de exoneración: caso fortuito, malquerencia de extraños y dolo o culpa grave (art. 48 LCS)",
      "7.5. El desplazamiento del objeto asegurado (art. 47 LCS)",
      "7.6. Los fenómenos eléctricos como riesgo asimilado",
      "7.7. Ficha para el profesional",
      "7.8. Ficha para el asegurado",
      "7.9. Checklist: acreditación de un siniestro de incendio",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("7.1. El concepto legal de incendio"),
    ...
    B.h2("7.2. Extensión de la cobertura y daños indemnizables"),
    ...
    B.h2("7.3. Objetos de valor y bienes excluidos de la cobertura estándar"),
    ...
    B.h2("7.4. Causas de exoneración: caso fortuito, malquerencia de extraños y dolo o culpa grave"),
    ...
    B.h2("7.5. El desplazamiento del objeto asegurado"),
    ...
    B.h2("7.6. Los fenómenos eléctricos como riesgo asimilado"),
    ...
    B.h2("7.9. Checklist: acreditación de un siniestro de incendio"),
