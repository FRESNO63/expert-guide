...
function capitulo07() {
  return [
    B.chapterHeading(7, "Robo, expoliación y hurto"),

    B.sumario([
      "7.1. El concepto legal de robo a efectos aseguraticios (art. 50 LCS)",
      "7.2. Alcance de la indemnización (art. 51 LCS)",
      "7.3. Causas legales de exoneración (art. 52 LCS)",
      "7.4. La recuperación del objeto sustraído (art. 53 LCS)",
      "7.5. Hurto y expoliación: la frontera con el robo en sentido técnico",
      "7.6. La prueba del siniestro de robo",
      "7.7. Ficha para el profesional",
      "7.8. Ficha para el asegurado",
      "7.9. Checklist: acreditación de un siniestro de robo",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("7.1. El concepto legal de robo a efectos aseguraticios"),
    ...
    B.p("La remisión a «cualquiera de sus formas» de comisión del delito permite entender cubiertos, salvo exclusión expresa, tanto el robo con fuerza en las cosas (la modalidad más habitual en el ámbito doméstico: fractura de puerta, ventana o cerradura) como el robo con violencia o intimidación en las personas, mientras que el hurto (sustracción sin fuerza ni violencia) y la apropiación indebida quedan, en la práctica de las pólizas de hogar, sujetos a régimen contractual específico, según se analiza en el epígrafe 7.5."),

    B.h2("7.2. Alcance de la indemnización"),
    ...
    B.h2("7.3. Causas legales de exoneración"),
    ...
    B.h2("7.4. La recuperación del objeto sustraído"),
    ...
    B.h2("7.5. Hurto y expoliación: la frontera con el robo en sentido técnico"),
    ...
    B.h2("7.6. La prueba del siniestro de robo"),
    ...
    B.h2("7.7. Ficha para el profesional"),
    ...
    B.h2("7.8. Ficha para el asegurado"),
    ...
    B.h2("7.9. Checklist: acreditación de un siniestro de robo"),
