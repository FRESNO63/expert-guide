...
function capitulo22() {
  return [
    B.chapterHeading(22, "Casos prácticos resueltos"),
    ...
    ...caso(
      ...
      "En daños por agua, la discusión jurídica sobre la naturaleza de la cláusula (capítulo 4) es solo la mitad de la batalla: la otra mitad, con frecuencia decisiva, se libra en el terreno pericial sobre la causa técnica exacta del daño (capítulo 6)."
    ),
    ...
    ...caso(
      ...
      "El capítulo 7 explica que el umbral de negligencia grave en el seguro de robo es más exigente que la negligencia leve, pero exige una situación de auténtico abandono o dejación en la custodia del bien (SAP Barcelona, Sección 16.ª, de 11 de enero de 2017, ROJ: SAP B 5946/2017, sobre una embarcación amarrada de forma manifiestamente precaria). El capítulo 17 recuerda, además, que la carga de la prueba de la negligencia grave corresponde siempre a la aseguradora que la invoca (STS de 17 de julio de 2012, ROJ: STS 5990/2012).",
