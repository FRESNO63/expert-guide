...
function capitulo22() {
  return [
    B.chapterHeading(22, "Prescripción de acciones"),

    B.sumario([
      "22.1. El plazo de dos años del art. 23 LCS",
      "22.2. La interrupción de la prescripción (art. 1973 CC)",
      "22.3. El dies a quo: la regla de la actio nata",
      "22.4. Incidencia de un proceso penal previo sobre el cómputo",
      "22.5. Prescripción de la acción de subrogación (art. 43 LCS)",
      "22.6. Ficha para el profesional",
      "22.7. Ficha para el asegurado",
      "22.8. Checklist: cómputo del plazo de prescripción",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("22.1. El plazo de dos años del art. 23 LCS"),
    ...
    B.h2("22.2. La interrupción de la prescripción"),
    ...
    B.h2("22.3. El dies a quo: la regla de la actio nata"),
    ...
    B.h2("22.4. Incidencia de un proceso penal previo sobre el cómputo"),
    ...
    B.h2("22.7. Ficha para el asegurado"),
    ...
    B.h2("22.8. Checklist: cómputo del plazo de prescripción"),
