...
function capitulo21() {
  return [
    ...
    B.sumario([
      "21.1. Sistemática general: dolo, mala fe y culpa grave en la LCS",
      "21.2. El estándar probatorio: la carga de la prueba corresponde al asegurador",
      "21.3. La exigencia de nexo causal entre el dolo y el siniestro",
      "21.4. El umbral de la culpa grave frente a la negligencia simple",
      "21.5. Proyección sobre las distintas coberturas del hogar",
      "21.6. Ficha para el profesional",
      "21.7. Ficha para el asegurado",
      "21.8. Checklist: análisis de una imputación de dolo o culpa grave",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("21.1. Sistemática general: dolo, mala fe y culpa grave en la LCS"),
    ...
    B.h2("21.2. El estándar probatorio: la carga de la prueba corresponde al asegurador"),
    ...
    B.h2("21.3. La exigencia de nexo causal entre el dolo y el siniestro"),
    ...
    B.h2("21.4. El umbral de la culpa grave frente a la negligencia simple"),
    ...
    B.h2("21.5. Proyección sobre las distintas coberturas del hogar"),
    ...
    B.h2("21.6. Ficha para el profesional"),
    ...
    B.h2("21.7. Ficha para el asegurado"),
    ...
    B.h2("21.8. Checklist: análisis de una imputación de dolo o culpa grave"),
