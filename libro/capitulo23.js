...
function capitulo23() {
  return [
    ...
    B.sumario([
      "23.1. El deber de atención al reclamante: SAC y Defensor del Asegurado",
      "23.2. La reclamación ante la Dirección General de Seguros y Fondos de Pensiones",
      "23.3. Los medios adecuados de solución de controversias como requisito de procedibilidad",
      "23.4. Los intereses del art. 20 LCS como palanca de negociación extrajudicial",
      "23.5. Ficha para el profesional",
      "23.6. Ficha para el asegurado",
      "23.7. Checklist: itinerario extrajudicial antes de demandar",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("23.1. El deber de atención al reclamante: SAC y Defensor del Asegurado"),
    ...
    B.h2("23.2. La reclamación ante la Dirección General de Seguros y Fondos de Pensiones"),
    ...
    B.h2("23.3. Los medios adecuados de solución de controversias como requisito de procedibilidad"),
    ...
    B.h2("23.4. Los intereses del art. 20 LCS como palanca de negociación extrajudicial"),
    ...
    B.h2("23.5. Ficha para el profesional"),
    ...
    B.h2("23.6. Ficha para el asegurado"),
    ...
    B.h2("23.7. Checklist: itinerario extrajudicial antes de demandar"),
