...
function capitulo25() {
  return [
    B.chapterHeading(25, "Cláusulas abusivas y protección de los consumidores"),

    B.sumario([
      "25.1. El tomador del seguro de hogar como consumidor",
      "25.2. El triple control de las condiciones generales: incorporación, transparencia y contenido",
      "25.3. El concepto legal de cláusula abusiva y su relación con el art. 3 LCS",
      "25.4. Consecuencias de la abusividad: nulidad y subsistencia del contrato",
      "25.5. Ficha para el profesional",
      "25.6. Ficha para el asegurado",
      "25.7. Checklist: análisis de una cláusula desde la perspectiva de consumo",
    ]),
    B.spacer(160),
    B.abstractBlock(
      "El capítulo cierra el estudio de las condiciones generales del seguro de hogar iniciado en los capítulos 1 y 5, añadiendo el tercer y último nivel de control aplicable cuando el tomador ostenta la condición de consumidor: el control de contenido o de abusividad del Texto Refundido de la Ley General para la Defensa de los Consumidores y Usuarios, que la jurisprudencia mantiene cuidadosamente diferenciado tanto del control de incorporación —aplicable a todo adherente— como del propio régimen del art. 3 LCS.",
    ...
    B.h2("25.2. El triple control de las condiciones generales: incorporación, transparencia y contenido"),
    ...
    B.bullet([B.bold("Control de incorporación (arts. 5 y 7 LCGC, capítulo 5): "), B.run("aplicable a todo adherente, sea o no consumidor. Verifica si la cláusula llegó a formar parte del contrato (oportunidad real de conocerla, legibilidad).")]),
    B.bullet([B.bold("Control específico del art. 3 LCS (capítulos 1 y 5): "), B.run("aplicable a todo asegurado, sea o no consumidor, en su condición de destinatario específico de la protección de la LCS. Exige el destacado formal y la aceptación específica de las cláusulas limitativas.")]),
    ...
    B.h2("25.3. El concepto legal de cláusula abusiva y su relación con el art. 3 LCS"),
    ...
    B.h2("25.4. Consecuencias de la abusividad: nulidad y subsistencia del contrato"),
    ...
    B.h2("25.5. Ficha para el profesional"),
    ...
    B.h2("25.6. Ficha para el asegurado"),
    ...
    B.h2("25.7. Checklist: análisis de una cláusula desde la perspectiva de consumo"),
