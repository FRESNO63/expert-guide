...
function capitulo15() {
  return [
    B.chapterHeading(15, "Infraseguro, sobreseguro y regla proporcional"),
    ...
    B.p(["La distinción entre infraseguro (defecto de suma asegurada dentro de una misma póliza) y concurrencia de seguros (pluralidad de pólizas sobre un mismo riesgo e interés, estudiada en el capítulo 6 a propósito del art. 32 LCS) es, pese a su aparente sencillez conceptual, fuente frecuente de confusión práctica, como ilustra una sentencia ya clásica de la Sala Primera dictada precisamente en un supuesto en que el asegurado pretendió, sin éxito, reconducir un problema de infraseguro a la figura de la concurrencia de seguros"]),
