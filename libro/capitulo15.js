...
function capitulo15() {
  return [
    B.chapterHeading(15, "Coberturas especiales: joyas, objetos de valor, equipos electrónicos y comunidades de propietarios"),
    ...
    B.p("Cuando existe seguro de comunidad, su interacción con la póliza individual de cada propietario debe analizarse, como se expuso en el capítulo 8 a propósito de la STS 1227/2025 (ROJ: STS 1227/2025), verificando la identidad de riesgo e interés asegurado en cada caso concreto: la propia sentencia distingue expresamente los supuestos de «coberturas concurrentes de elementos privativos de inmuebles en propiedad horizontal» —en los que resulta más fácil apreciar dicha identidad y, por tanto, aplicar la contribución proporcional del art. 32 LCS— de otros supuestos, como el arrendamiento, en los que el interés asegurado por cada póliza puede ser sustancialmente distinto."),
    ...
    B.bullet([B.bold("Alquiler vacacional y teletrabajo: "), B.run("el uso de la vivienda para alquiler turístico de corta duración o para el desarrollo de una actividad profesional o empresarial puede constituir, si no fue declarado al contratar, una circunstancia relevante para la valoración del riesgo (art. 10 LCS) o una agravación sobrevenida (art. 11 LCS) sujeta al régimen ya estudiado en el capítulo 4, por lo que su comunicación expresa a la aseguradora es una cautela elemental antes de destinar la vivienda a estos usos.")]),
    ...
    B.fichaBox("Puntos de control sobre coberturas especiales", B.AZUL, [
      ...
      "Aplicar la metodología del capítulo 5 (incorporación, calificación, requisitos formales, interpretación) a cada sublímite controvertido, con particular atención a su carácter sorpresivo.",
