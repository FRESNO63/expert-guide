...
function capitulo17() {
  return [
    ...
    B.sumario([
      "17.1. El deber de comunicación del siniestro (art. 16 LCS)",
      "17.2. Plazo y consecuencias del incumplimiento",
      "17.3. El deber de información sobre las circunstancias del siniestro",
      "17.4. La prueba del conocimiento del siniestro por otro medio",
      "17.5. Ficha para el profesional",
      "17.6. Ficha para el asegurado",
      "17.7. Checklist: comunicación de un siniestro de hogar",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("17.1. El deber de comunicación del siniestro"),
    ...
    B.h2("17.2. Plazo y consecuencias del incumplimiento"),
    ...
    B.h2("17.3. El deber de información sobre las circunstancias del siniestro"),
    ...
    B.h2("17.4. La prueba del conocimiento del siniestro por otro medio"),
    ...
    B.h2("17.5. Ficha para el profesional"),
    ...
    B.h2("17.6. Ficha para el asegurado"),
    ...
    B.h2("17.7. Checklist: comunicación de un siniestro de hogar"),
