...
function capitulo05() {
  return [
    B.chapterHeading(5, "Incendio, explosión y fenómenos eléctricos"),
    ...
    B.p("El artículo 46 LCS excluye, salvo pacto expreso en contrario, determinados bienes de especial valor de la cobertura estándar de incendio, exclusión que la práctica aseguradora traslada sistemáticamente a las condiciones generales de las pólizas de hogar mediante los sublímites para joyas, dinero en efectivo y objetos de arte estudiados en el capítulo 11:"),
    ...
    B.bullet("2. ¿Se ha designado perito de parte conforme al art. 38 LCS (capítulo 14)?"),
