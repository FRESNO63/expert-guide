...
function capitulo05() {
  return [
    ...
    B.sumario([
      "5.1. Jerarquía y articulación entre condiciones generales, particulares y especiales",
      "5.2. El control de incorporación: entrega de la póliza y accesibilidad real de las condiciones",
      "5.3. El control de interpretación: la regla contra proferentem (art. 1288 CC)",
      "5.4. Casuística de cláusulas típicas en el seguro de hogar",
      "5.5. El control de contenido cuando el tomador es consumidor: remisión",
      "5.6. Ficha para el profesional",
      "5.7. Ficha para el asegurado",
      "5.8. Checklist: banderas rojas en la redacción de una póliza",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("5.1. Jerarquía y articulación entre condiciones generales, particulares y especiales"),
    ...
    B.h2("5.3. El control de interpretación: la regla contra proferentem"),
    ...
    B.p(["El propio doble requisito formal del art. 3 LCS para las cláusulas limitativas —destacado especial y aceptación específica por escrito— fue objeto de una sistematización de referencia por el Pleno de la Sala Primera, que conviene tener presente como compendio de la jurisprudencia anterior y posterior en la materia"]),
    B.jurisBox("STS (Pleno), Sala de lo Civil, de 14 de julio de 2015 (ROJ: STS 3754/2015; ECLI:ES:TS:2015:3754; MP: Sastre Papiol)", "«La exigencia de que las cláusulas limitativas de derechos figuren “destacadas de modo especial”, tiene la finalidad de que el asegurado tenga un conocimiento exacto del riesgo cubierto. La jurisprudencia de esta Sala exige que deben aparecer en las condiciones particulares y no en las condiciones generales, por más que, en estas últimas declare conocer aquéllas [...]. Respecto a la exigencia de que las cláusulas limitativas deban ser “especialmente aceptadas por escrito”, es un requisito que debe concurrir cumulativamente con el anterior, por lo que es imprescindible la firma del tomador. [...] En ningún caso se ha exigido por esta Sala una firma para cada una de las cláusulas limitativas.»"),
    B.p(["La sentencia tiene, además, un valor añadido de sistematización: reafirma que la distinción entre cláusulas delimitadoras y limitativas arranca de la Sentencia de Pleno de 11 de septiembre de 2006 —ya citada en el capítulo 1— y compendia, con cita expresa, la doctrina posterior sobre el «abigarramiento» de exclusiones heterogéneas agrupadas de forma que dificulta su comprensión (STS de 19 de julio de 2012) y sobre las distintas formas de acreditar la aceptación específica, ya sea mediante firma al final de las condiciones particulares, ya mediante remisión a un documento aparte debidamente firmado", B.fn("Estas dos últimas reglas complementarias —el criterio del «abigarramiento» como indicio de falta de destacado real, y la admisión de la aceptación por remisión a documento aparte firmado— proceden, según la propia STS 3754/2015, de una línea de precedentes reiterada de la Sala Primera; se citan aquí por su valor sistemático tal y como aparecen compendiadas en dicha sentencia, sin verificación independiente de cada uno de los precedentes originarios más allá de la propia STS 3754/2015."), ". A efectos prácticos, esta sentencia constituye la referencia obligada para argumentar, en cualquier escrito, tanto la falta de destacado especial (cláusula «abigarrada» o mezclada con exclusiones heterogéneas) como la falta de aceptación específica (ausencia de firma en el documento donde figura la cláusula) de una condición controvertida."]),

    B.h2("5.4. Casuística de cláusulas típicas en el seguro de hogar"),
    ...
    B.h2("5.5. El control de contenido cuando el tomador es consumidor: remisión"),
    ...
    B.h2("5.6. Ficha para el profesional"),
    B.fichaBox("Metodología de análisis de una cláusula controvertida", B.AZUL, [
      ...
      "Paso 3 — Requisitos formales: si es limitativa, ¿cumple el destacado tipográfico y la aceptación específica del art. 3 LCS? Contrastar con el doble test de la STS 3754/2015 (Pleno): ubicación en condiciones particulares, ausencia de abigarramiento, y firma del tomador (directa o por remisión a documento aparte).",
    ...
    B.h2("5.7. Ficha para el asegurado"),
    ...
    B.h2("5.8. Checklist: banderas rojas en la redacción de una póliza"),
