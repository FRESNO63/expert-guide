...
function capitulo20() {
  return [
    B.chapterHeading(20, "Pago de la indemnización, mora del asegurador e intereses"),

    B.sumario([
      "20.1. El pago del importe mínimo (art. 18 LCS)",
      "20.2. La mora del asegurador y su régimen especial (art. 20 LCS)",
      "20.3. Cálculo de los intereses de demora",
      "20.4. La causa justificada de exoneración: doctrina restrictiva del Tribunal Supremo",
      "20.5. La pendencia de un proceso judicial como (in)suficiente causa justificada",
      "20.6. Ficha para el profesional",
      "20.7. Ficha para el asegurado",
      "20.8. Checklist: reclamación de intereses del art. 20 LCS",
    ]),
    B.spacer(160),
    B.abstractBlock(
    ...
    B.h2("20.1. El pago del importe mínimo"),
    ...
    B.h2("20.2. La mora del asegurador y su régimen especial"),
    ...
    B.bullet([B.bold("Dies a quo: "), B.run("la fecha del siniestro, salvo incumplimiento del deber de comunicación en plazo, en cuyo caso el término inicial se traslada a la fecha de la comunicación (capítulo 17).")]),
    ...
    B.h2("20.3. Cálculo de los intereses de demora"),
    ...
    B.h2("20.4. La causa justificada de exoneración: doctrina restrictiva del Tribunal Supremo"),
    ...
    B.h2("20.5. La pendencia de un proceso judicial como (in)suficiente causa justificada"),
    ...
    B.fichaBox("Puntos de control para la reclamación de intereses del art. 20 LCS", B.AZUL, [
      "Fijar con precisión la fecha del siniestro como dies a quo, salvo incumplimiento del deber de comunicación en plazo (capítulo 17).",
    ...
    B.h2("20.8. Checklist: reclamación de intereses del art. 20 LCS"),
